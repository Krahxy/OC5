    ...
    <div class="usersList modalView">
        <table class="userTable">
            ...
            while ($user = $users -> fetch()) { ?>
                <tr>
                    <th scope="col"><?php echo $user['pseudo']; ?></th>
                    <th scope="col"><?php echo $user['email'] ?></th>
                    <th scope="col"><?php echo $user['admin'] == 1 ? 'Oui' : 'Non';?></th>
                    <th scope="col">
<?php                   if ($user['admin'] == 1) {
                            echo 'Déjà admin';
                        } else { ?>
                            <a href="index.php?action=updateRole-id-<?php echo $user['id'];?>-admin-<?php echo $user['admin'];?>" class="btn btn-warning">Passer admin</a>
                    </th><?php
                    }?>
                </tr>
        <?php
